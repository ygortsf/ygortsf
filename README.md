...
* 🎓 **Formação:** Cursando SIN na Universidade Católica de Pernambuco (2024-2026).
* 💼 **Gestão de Projetos:** Vivência prática no **âmbito profissional**, atuando na idealização, documentação (Figma) e gestão via Scrum/Kanban.
* 🌎 **Idiomas:** Inglês nível **B1 (Intermediário)**.
...
<p align="center">
  "Transformando ideias em soluções e requisitos em resultados." 🚀
</p>
